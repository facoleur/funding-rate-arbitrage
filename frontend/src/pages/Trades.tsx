...
export default function Trades() {
  ...
  const { data, isLoading, isError } = useQuery({
    queryKey: ['trades', modeFilter, statusFilter],
    queryFn: () =>
      fetchTrades({
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="mb-4 flex flex-shrink-0 gap-3">
        <Select value={modeFilter} onChange={(v) => setModeFilter(v as Mode | '')}>
        ...
        <Select value={statusFilter} onChange={(v) => setStatusFilter(v as TradeStatus | '')}>
