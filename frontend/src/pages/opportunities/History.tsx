...
/** Pas de pagination : on charge le max autorisé par l'API en une fois, la table scrolle en interne. */
    ...
    <div className="flex h-full flex-col">
      <div className="flex-shrink-0 space-y-5">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Select value={statusFilter} onChange={(v) => setStatus(v as OpportunityStatus | '')}>
              ...
              <DataTable>
                ...
                <tbody>
                  {stats.map((s) => (
                    <tr
                      key={s.pair}
                      onClick={() => setPairFilter(pairFilter === s.pair ? '' : s.pair)}
      ...
      <div className="mt-5 flex min-h-0 flex-1 flex-col">
        <div className="mb-2 flex flex-shrink-0 items-center gap-3">
              ...
              <tbody>
                {opps.map((o) => (
                  <tr key={o.id} className="hover:bg-zinc-900/40">
                    ...
                    <Td>
                      <span
                        className={o.network === 'mainnet' ? 'text-emerald-500' : 'text-amber-500'}
                      >
                        {o.network}
                      </span>
                    </Td>
